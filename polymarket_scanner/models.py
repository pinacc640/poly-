...
- take_profit_price field              on Stable/Vol/SmartMoney opportunities
- SmartMoneyOpportunity.price_impact_ratio  new whale-filter metric
- SmartMoneyOpportunity.is_breakout         breakout confirmation flag
"""
...
class StableOpportunity:
    ...
    # Phase 3: Take Profit (stamped by RiskController)
...
class VolatilityOpportunity:
    ...
    # Phase 3: Take Profit (stamped by RiskController; equals target_price for vol)
    take_profit_price: float = 0.0
...
class SmartMoneyOpportunity:
    ...
    # Phase 3: price-impact whale filter fields
    price_impact_ratio: float = 0.0  # abs(Δprice) / (volume/liquidity) — whale filter
