...
class AccountConfig:
    ...
    # 0.80 = capture 80% of the AI edge gap; avoids waiting for full settlement.
    ...
    # Require impact ratio >= threshold to confirm real directional conviction.
    sm_min_price_impact_ratio: float = 0.10

    # Breakout confirmation: abs(price_change_24h) must exceed this for HIGH confidence.
    # Separates genuine directional conviction from noise.
